...
cd ../
./python-3.6.8-embed-amd64/python -m pip install -r requirements.txt --no-warn-script-location
# ./python-3.6.8-embed-amd64/python -m pip install openpyxl==2.6.3 --no-warn-script-location